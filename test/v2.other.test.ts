...
Deno.test('digestFromManifestStr', () => {
    var v1Manifest = {
       'schemaVersion': 1,
    ...
    var v1Digest = digestFromManifestStr(v1ManifestStr);
    assertEquals(v1Digest, 'sha256:b524e5d7837da98010567886762935bf3c10ad5ac1ff5112bc43299329ca9a54');
    ...
    var v2Digest = digestFromManifestStr(v2ManifestStr);
